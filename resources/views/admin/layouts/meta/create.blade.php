...
@section('title', "Додати Meta теги {$route}")
...
@section('content')
    @include('admin.includes.index.content-header', ['mainTitle' => "Додати Meta теги  {$route}"])
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('meta.store', $route) }}" method="POST">
                @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('en_keywords') is-invalid @enderror"
                                name="en_keywords" id="en_keywords" value='{{ old('en_keywords') }}'>
                            @include('includes.show-error', ['name' => 'en_keywords'])
                        </div>
                        <div class="mb-3">
                            <label for="en_lang" class="form-label">Lang EN</label>
                            <input type="text" class="form-control  @error('en_lang') is-invalid @enderror"
                                name="en_lang" id="en_lang" value='{{ old('en_lang') }}' required>
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ua_keywords') is-invalid @enderror"
                                name="ua_keywords" id="ua_keywords" value='{{ old('ua_keywords') }}'>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ua_lang') is-invalid @enderror" name="ua_lang"
                                id="ua_lang" value='{{ old('ua_lang') }}' required>
